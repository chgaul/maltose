...
# basic settings
model_dir = os.path.join(data.paths.model_dir, "multitask_model_only_pbe0")
...
properties = ['HOMO-PBE0', 'LUMO-PBE0', 'Gap-PBE0']
batch_size = 8
...
meanstensor = torch.tensor([-6.48, -1.56, 4.92])
stddevstensor = torch.tensor([0.71, 0.91, 1.17])
