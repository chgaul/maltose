...
# - With respect to multiask_model ("" a.k.a. "_v01"), the Set2Set output module is replaced with the avg output module.
...
# basic settings
model_dir = os.path.join(data.paths.model_dir, "multitask_model_v01_avg")
