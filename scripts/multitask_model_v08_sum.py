...
# - With respect to multiask_model_v08, the Set2Set output module is replaced with the sum output module (mind the statistics in meanstensor and stddevtensor).
...
# basic settings
model_dir = os.path.join(data.paths.model_dir, "multitask_model_v08_sum")
